<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="array.aspx.cs" Inherits="WebServerControls.array" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
        ...
        <p>
            ...
            <b>Condition</b>: Enter only numeric values without decimal between 1-99 only. Exceptions are not caught.<br />
        </p>
            <hr />
...
<asp:Content ID="Content2" ContentPlaceHolderID="CodeWindow" Runat="Server">
    <script src="http://gist-it.appspot.com/https://github.com/MaharajSanthir/csharp_exercises/blob/master/csharp_exercises/selfStudy/array.aspx.cs"></script>
</asp:Content>